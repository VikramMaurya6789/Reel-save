...
fun ReelSaveTheme(
  ...
  dynamicColor: Boolean = false, // Keep consistent branding by default, user can toggle in settings
...
fun MyApplicationTheme(
  ...
  ReelSaveTheme(darkTheme = darkTheme, dynamicColor = dynamicColor, content = content)
}
